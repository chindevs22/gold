...
class WCPBC_Setup_Wizard {
	...
	public static function enqueue_scripts() {
		wp_enqueue_style( 'wcpbc-setup-wizard-styles', WCPBC()->plugin_url() . 'assets/css/admin/setup-wizard.css', array(), WCPBC()->version );
		wp_register_script( 'wcpbc-setup-wizard', WCPBC()->plugin_url() . 'assets/js/admin/setup-wizard.js', array( 'jquery', 'jquery-blockui', 'wp-util' ), WCPBC()->version, true );
		wp_localize_script(
			'wcpbc-setup-wizard',
	...
	public static function add_loading_classes( $classes ) {
		$classes .= ' wcpbc-admin-full-screen wcpbc-setup-wizard';
