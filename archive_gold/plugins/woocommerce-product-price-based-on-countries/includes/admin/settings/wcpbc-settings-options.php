		...
		'fields'    => array_merge(
			array(
				...
				array(
					...
					'type'    => 'select',
					'class'   => 'wc-enhanced-select',
					'options' => wcpbc_is_pro() && class_exists( 'WCPBC_Update_Exchange_Rates' ) ? wc_list_pluck( WCPBC_Update_Exchange_Rates::get_providers(), 'get_name' ) : array(
						'FloatRates',
						'Open Exchange Rates',
						'X-Rates',
					),
			...
			( wcpbc_is_pro() ? WCPBC_Update_Exchange_Rates::get_providers_fields() : array() )
		),
	),
