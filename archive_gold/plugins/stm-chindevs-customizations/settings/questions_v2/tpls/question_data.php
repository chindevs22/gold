<template v-if="typeof item !== 'undefined'">
	...
	<div class="section_data">
		...
		<div class="section_data__actions">
            ...
            <div class="slms-points-input-wrap" style="opacity:1;padding-right:20px;">
                <label class="slms-points-label" style="display:inline-block;margin-right:5px;font-weight:600;">
                    <?php esc_html_e( 'Points', 'slms' ); ?>
                </label>
                <input type="number" class="slms-points-input" v-model="items[item_key]['slms_points']"
                       min="0" max="9999" step="1"
                       style="width:60px;height:30px;padding:5px;display:inline-block;">
            </div>
