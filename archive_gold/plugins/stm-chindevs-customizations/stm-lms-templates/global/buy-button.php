				...
				<?php if ( ! empty( $price ) || ! empty( $sale_price ) ) : ?>
					<div class="btn-prices">
						<?php if ( ! empty( $sale_price ) ) : ?>
							<label class="sale_price"><?php echo wp_kses_post( SLMS_Course_Price::display_price( $sale_price ) ); ?></label>
						<?php endif; ?>

						<?php if ( ! empty( $price ) ) : ?>
							<label class="price"><?php echo wp_kses_post( SLMS_Course_Price::display_price( $price ) ); ?></label>
						<?php endif; ?>
