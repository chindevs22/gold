...
function slms_price_format(price, currency){
    price = stm_lms_price_format_number(price);
    price = stm_lms_vars['position'] === 'left' ? currency + price : price + currency;
    return price;
}
...
(function ($) {
    ...
    $(document).ready(function () {
        ...
        function calculatePrice() {
            ...
            var currency = $price_btn.data('enterprise-currency');
            $price_btn.find('span').html(slms_price_format(price * total, currency));
            disableBuy();
        }
