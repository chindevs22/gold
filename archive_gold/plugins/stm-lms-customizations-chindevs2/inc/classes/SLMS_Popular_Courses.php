...
class SLMS_Popular_Courses extends WP_Widget {
...
//                    $price   = ( ! empty( $meta['sale_price'] ) ) ? $meta['sale_price'] : $price;
                    ...
                    $price             = SLMS_Course_Price::get( $post_id );
                    $sale_price        = SLMS_Course_Price::get_sale( $post_id );
                                ...
                                <?php else : ?>
                                    <div class="stm_featured_product_price">
                                        <div class="price <?php echo esc_attr( ( ! empty( $price ) ) ? 'price-pay' : 'price-free' ); ?>">
                                            <?php echo esc_html( ( ! empty( $price ) ) ? SLMS_Course_Price::display_price( $price ) : __( 'Free', 'masterstudy-lms-learning-management-system' ) ); ?>
                                        </div>
                                    </div>
                                <?php endif; ?>
...
function slms_register_popular_courses() {
    register_widget( 'SLMS_Popular_Courses' );
}

remove_action( 'widgets_init', 'stm_lms_register_popular_courses' );
add_action( 'widgets_init', 'slms_register_popular_courses' );
