                    ...
                    <br><br>
                        ...
                        <div class="postbox">
                            ...
                            <div class="inside">
                                ...
                                <textarea style="width:100%; height:500px;"><?php /** @noinspection PhpIncludeInspection */
                                        include(Woocommerce_Pay_Per_Post_Helper::logger_uri()); ?></textarea>
                            <?php endif; ?>
                            </div>
                            ...
                            <table class="wp-list-table widefat fixed striped table-view-list">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?= \Carbon\Carbon::createFromTimestamp(Woocommerce_Pay_Per_Post_Debug::get_transient_timeout(str_replace('_transient_', '', $transient->option_name)))->diffForHumans();?></td>
                                    </tr>
                                    <?php endforeach; ?>
                                </tbody>
                            </table>
