    ...
    var sleepyAlert = setInterval(function () {
        ...
        if (count++ >= LIMIT) {
            ...
            (async() => {
                ...
                jQuery('div.masonry').after('<div class="fifu-pro" style="float:right;position:relative;top:-5px;left:-145px"><a class="fifu-pro-link" href="https://fifu.app/" target="_blank" title="Unlock all PRO features for $29.90"><span class="dashicons dashicons-lock fifu-pro-icon"></span></a></div><center><div id="fifu-loading"><img src="https://cdnjs.cloudflare.com/ajax/libs/jquery.lazyloadxt/1.1.0/loading.gif"><div>Loading more...</div><div></center>');
