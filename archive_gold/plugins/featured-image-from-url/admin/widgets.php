...
class Fifu_Widget_Image extends WP_Widget {
    ...
    public function form($instance) {
        ...
        echo '<div class="fifu-pro" style="float:right;position:relative;right:-30px;top:-5px"><a class="fifu-pro-link" href="https://fifu.app/" target="_blank" title="Unlock all PRO features for $29.90"><span class="dashicons dashicons-lock fifu-pro-icon"></span></a></div>';
