...
class MsLmsCoursesSearchboxChild extends Widget_Base {
    ...
    protected function register_content_controls() {
        ...
        $this->add_control( 'include_lite_courses',
            array(
                'type'               => Controls_Manager::SWITCHER,
                'label'              => esc_html__( 'For lite courses', 'slms' ),
    ...
    protected function render() {
        ...
        $atts     = array(
            ...
            'include_lite_courses'        => $settings['include_lite_courses'],
        );
