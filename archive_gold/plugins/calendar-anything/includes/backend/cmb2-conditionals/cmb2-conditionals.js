jQuery(document).ready(function ($) {
    ...
    CMB2ConditionalsInit('#post .cmb2-wrap', '#post .cmb2-wrap'); // TODO: FIX BUG: NOTIFY GITHUB
    CMB2ConditionalsInit('.wp-admin.post-php .cmb2-wrap', '.wp-admin.post-php .cmb2-wrap'); // gutenberg fix
    CMB2ConditionalsInit('#cmcal_setup_metabox .cmb2-wrap', '#cmcal_setup_metabox .cmb2-wrap'); // TODO: FIX BUG: NOTIFY GITHUB
    CMB2ConditionalsInit('#cmcal_setup_post_fields_metabox .cmb2-wrap', '#cmcal_setup_post_fields_metabox .cmb2-wrap'); // TODO: FIX BUG: NOTIFY GITHUB
    CMB2ConditionalsInit('#cmcal_setup_date_fields_metabox .cmb2-wrap', '#cmcal_setup_date_fields_metabox .cmb2-wrap'); // TODO: FIX BUG: NOTIFY GITHUB
});
