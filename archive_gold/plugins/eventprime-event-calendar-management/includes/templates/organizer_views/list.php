        ...
        <div class="ep-box-list-wrap">
            <div class="ep-box-row">
                ...
                <?php if (!empty($organizer->image_id)){ ?>
                        <a href="<?php echo $organizer_url; ?>" ><img src="<?php if (isset($organizer->image_id)) echo wp_get_attachment_image_src($organizer->image_id, 'large')[0]; else echo esc_url(EM_BASE_FRONT_IMG_URL.'dummy_image.png'); ?>" alt="<?php _e('Event Organizer Image', 'eventprime-event-calendar-management'); ?>"> </a>
                <?php }else{ ?>
                    <a href="<?php echo $organizer_url; ?>" > <img src="<?php echo esc_url(plugins_url('../images/dummy-organizer.png', __FILE__)) ?>" alt="<?php _e('Dummy Image','eventprime-event-calendar-management'); ?>"> </a>
                <?php } ?>  
            ...
            <div class="ep-box-col-6 ep-list-box-table">
                <div class="ep-box-list-items">
                    <div class="ep-box-title ep-box-list-title">
                        <a class="ep-color-hover" data-organizer-id="<?php echo $organizer->id;?>" href="<?php echo $organizer_url; ?>" target="_self" rel="noopener">
