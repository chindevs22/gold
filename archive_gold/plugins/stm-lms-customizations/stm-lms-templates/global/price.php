...
$price = SLMS_Course_Price::get();
$sale_price = SLMS_Course_Price::get_sale();
...
if (!$not_salebale): ?>
    <div class="stm_lms_courses__single--price heading_font">
        ...
        <?php elseif (!empty($price) and !empty($sale_price)): ?>
            <span><?php echo SLMS_Course_Price::display_price($price); ?></span>
            <strong><?php echo SLMS_Course_Price::display_price($sale_price); ?></strong>
        <?php else: ?>
            <strong><?php echo SLMS_Course_Price::display_price($price); ?></strong>
        <?php endif; ?>
    </div>
<?php else :
