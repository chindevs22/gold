...
$question_template = (SLMS_Quiz::show_answers($item_id)) ? 'questions/answers/' . $type : 'questions/' . $type;
...
<div class="stm-lms-single_question stm-lms-single_question_<?php echo esc_attr($type); ?> correct_answer_<?php echo esc_attr($correct_answer) ?>"
    ...
    <?php if ($type !== 'question_bank'): ?>
        ...
        <?php if (!empty($question_explanation) and SLMS_Quiz::show_answers($item_id)): ?>
