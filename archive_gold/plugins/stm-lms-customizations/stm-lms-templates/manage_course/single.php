...
wp_enqueue_script( 'stm-lms-manage_course', SLMS_URL . 'assets/js/manage_course.js', array( 'vue.js', 'vue-resource.js' ), SLMS_VERSION, true );

wp_enqueue_media();
// phpcs:ignore WordPress.WP.EnqueuedResourceParameters.NotInFooter
wp_enqueue_script( 'stm_lms_mixins.js', $base . 'js/mixins.js', array( 'vue.js' ), $v );

wp_add_inline_script( 'stm-lms-manage_course', SLMS_Manage_Course::localize_script( $course_id ), 'before' );
