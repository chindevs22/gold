...
<head>
	...
	<link href="<?php echo esc_url( $styles->registered['dashicons']->src ); // phpcs:ignore ?>" rel="stylesheet">
	<link href="<?php echo esc_url( $styles->registered['editor-buttons']->src ); // phpcs:ignore ?>" rel="stylesheet">
...
<script src="<?php echo esc_url( $scripts->registered['jquery-core']->src ); // phpcs:ignore ?>"></script>
<script src="<?php echo esc_url( $scripts->registered['jquery-migrate']->src ); // phpcs:ignore ?>"></script>
<script src="<?php echo esc_url( $scripts->registered['wp-polyfill-inert']->src ); // phpcs:ignore ?>"></script>
<script src="<?php echo esc_url( $scripts->registered['regenerator-runtime']->src ); // phpcs:ignore ?>"></script>
<script src="<?php echo esc_url( $scripts->registered['wp-polyfill']->src ); // phpcs:ignore ?>"></script>
<script src="<?php echo esc_url( $scripts->registered['wp-hooks']->src ); // phpcs:ignore ?>"></script>
<script src="<?php echo esc_url( $scripts->registered['wp-i18n']->src ); // phpcs:ignore ?>"></script>
<script src="<?php echo esc_url( $scripts->registered['utils']->src ); // phpcs:ignore ?>"></script>
<script src="<?php echo esc_url( $scripts->registered['editor']->src ); // phpcs:ignore ?>"></script>
<?php
