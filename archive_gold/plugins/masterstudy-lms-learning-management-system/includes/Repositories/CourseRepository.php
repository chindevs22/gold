...
final class CourseRepository {
	...
	public function create( array $data ): int {
		...
		if ( current_user_can( 'administrator' ) || ! \STM_LMS_Options::get_option( 'course_premoderation', false ) ) {
	...
	public function save( Course $course ): void {
		...
		do_action( 'masterstudy_lms_course_save', $course );
	}
	...
	private function hydrate( \WP_Post $post ): Course {
		...
		$course->co_instructor     = isset( $meta['co_instructor'][0] )
			...
			: null;
		$course->current_students  = $meta['current_students'][0] ?? 0;
